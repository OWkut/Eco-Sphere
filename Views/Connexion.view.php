                    ...
                    <div class="card-body p-5 text-center">
                        ...
                        <form action="validation_connexion" method="post" onsubmit="return encryptPassword();">
                            <button class="btn btn-lg btn-block btn-light text-muted" type="button">
                                <img src="Public/assets/images/Google.png" alt="logoGoogle" width="30"> Se connecter avec Google
                            </button>
                            <hr class="my-4">
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <input type="email" id="email" name="email" class="form-control form-control-lg" placeholder="Entrez votre adresse mail" required />
                            </div>
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <div class="input-group">
                                    <input type="password" id="password" name="password" class="form-control form-control-lg" placeholder="Entrez votre mot de passe" required />
