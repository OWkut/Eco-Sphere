<nav class="bg-white shadow-md">
      ...
      <div class="flex justify-between h-16">
        <div class="flex">
          <a href="#" class="flex-shrink-0 flex items-center">
            <span class="text-xl font-bold text-blue-600">MyBrand</span>
          </a>
        ...
        <div class="flex items-center">
          <div class="hidden sm:ml-6 sm:flex sm:items-center">
            <a href="#" class="text-gray-900 hover:text-blue-500 px-3 py-2 rounded-md text-sm font-medium">Login</a>
            <a href="#" class="ml-4 bg-blue-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-blue-700">Sign Up</a>
          </div>
    ...
    <div class="sm:hidden">
      ...
      <div class="pt-4 pb-3 border-t border-gray-200">
        <a href="#" class="block text-gray-900 hover:bg-gray-50 hover:text-blue-500 px-3 py-2 rounded-md text-base font-medium">Login</a>
        <a href="#" class="block bg-blue-600 text-white hover:bg-blue-700 px-4 py-2 rounded-md text-base font-medium mt-2">Sign Up</a>
      </div>
    </div>
</nav>